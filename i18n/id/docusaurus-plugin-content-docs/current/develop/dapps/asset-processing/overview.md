...
- [internal message](/develop/smart-contracts/guidelines/internal-messages) is sent from one _blockchain entity_ to _another_, can carry some amount of digital assets and arbitrary portion of data.
